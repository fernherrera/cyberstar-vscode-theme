...
class Syntax:
    ...
    comments: str = "#000000"
    keywords: str = "#000000"
    constants: str = "#000000"
    decorators: str = "#000000"
    functions: str = "#000000"
    operators: str = "#000000"
    punctuation: str = "#000000"
    strings: str = "#000000"
    numbers: str = "#000000"
    types: str = "#000000"
    ...
    def build(self):
        return [
            ...
            self.__s("Keywords", keywords, self.keywords),
            self.__s("Constants", constants, self.constants),
            self.__s("Decorators", decorators, self.decorators),
            self.__s("Functions", functions, self.functions),
            self.__s("Operators", operators, self.operators),
            self.__s("Punctuation", punctuation, self.punctuation),
            self.__s("Strings", strings, self.strings),
...
typeConstructor = ["source.elm constant.type-constructor"]
type = ["source.elm storage.type"]

# HTML
markup_variables = ["support.variable.liquid", "support.class.liquid"]
markup_tags = [
...
markup_mdCodeLanguage = ["fenced_code.block.language"]
markup_mdList = ["punctuation.definition.list.begin"]
markup_mdListPunctuation = ["punctuation.definition.list.begin"]
markup_mdHeading = ["entity.name.section", "markup.heading.setext"]
markup_mdHeadingPunctuation = ["punctuation.definition.heading"]
markup_mdLink = ["markup.underline.link", "markup.underline.link.image"]
markup_mdItalic = ["markup.italic", "punctuation.definition.italic"]
markup_mdBold = ["markup.bold", "punctuation.definition.bold"]
markup_mdStriked = [
...
markup_mdQuotePunctuation = ["punctuation.definition.quote.begin"]
markup_component = [
...
markup_diffHead = ["source.diff meta.diff.header.command"]
markup_diffRange = [
...
styling_reference = ["entity.name.tag.reference", "meta.property-list"]
styling_property = [
